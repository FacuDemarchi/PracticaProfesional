...
export const ProfesorAltaAlumno = () => {
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        <button onClick={() => navigate('/profesor/salas')} style={styles.backBtn}>
          ← Volver
        </button>
        <h2 style={styles.title}>Alta de Alumno</h2>
      </div>

      {error && <div style={styles.error}>{error}</div>}
      {success && <div style={styles.success}>Alumno guardado exitosamente!</div>}
